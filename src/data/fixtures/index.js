...
const fileNodesFixture = fileNodes.map( node => { const {name, permissions, nodeIndex, extension, FileNodeId } = node.data; return {name, permissions, nodeIndex, extension, FileNodeId }});
