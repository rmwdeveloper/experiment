...
module.exports = { // Indices are always unique and static. A node only ever has one parent.
  ...
  4: { name: 'Guest', children: [11, 14, 15], permissions: 'rwxp', metadata: { isHomeFolder: true } },
  ...
  11: { name: 'Desktop', permissions: 'rwx-', children: [10, 12, 13, 14, 15, 22, 23, 24, 25, 26, 27, 28], metadata: { isDesktop: true } },
