...
module.exports = { // Indices are always unique and static. A node only ever has one parent.
  ...
  4: { name: 'Guest', children: [5, 11, 14, 15], permissions: 'rwxp', metadata: { isHomeFolder: true } },
  5: { name: 'Programs', children: [6, 9], permissions: 'rwx-' },
  6: { name: 'Office', children: [7, 8], permissions: 'rwx-' },
  7: { name: 'Word Processor', permissions: 'rwx-', extension: 'exe', metadata: { icon: 'wordlogoXSmall.png' } },
  8: { name: 'Spreadsheets', permissions: 'rwx-', extension: 'exe', metadata: { icon: 'excellogoXSmall.png' } },
  ...
  11: { name: 'Desktop', permissions: 'rwx-', children: [12, 13, 14, 15, 22, 24, 25, 26, 27, 28, 30, 31], metadata: { isDesktop: true } },
  ...
  24: { name: 'Mailr', permissions: 'rwx-', extension: 'exe', metadata: { sprite: true, icon: 'iconsSprite.gif', backgroundPosition: '200px 210px' } },
  ...
  27: { name: 'printer settings', permissions: 'rwx-', extension: 'exe', metadata: { sprite: true, icon: 'iconsSprite.gif', backgroundPosition: '200px 50px' } },
  ...
  30: { name: 'Resume', permissions: 'rwxp', extension: 'txt', metadata: { sprite: true, icon: 'iconsSprite.gif', backgroundPosition: '200px 100px' } },
  31: { name: 'Directions', permissions: 'rwxp', extension: 'txt', metadata: { sprite: true, icon: 'iconsSprite.gif', backgroundPosition: '200px 100px' } },
};