...
const initialState = {
  ...
  fileSystem: { // Indices are always unique and static. A node only ever has one parent.
    ...
    11: { name: 'Desktop', permissions: ['rwx-'], children: [10, 12, 13, 14, 15, 22, 23, 24, 25] },
    ...
    24: { name: 'test(3)', permissions: ['rwx-'], extension: 'txt', metadata: { sprite: true, icon: 'iconsSprite.gif', backgroundPosition: '200px 50px' } },
