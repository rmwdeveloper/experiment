...
export function resizeFileWindow(index, deltaX, deltaY, resizeStartWidth, resizeStartHeight) {
  return dispatch => {
    dispatch({ type: RESIZE_FILE_WINDOW, index, deltaX, deltaY, resizeStartWidth, resizeStartHeight });
  };
}
