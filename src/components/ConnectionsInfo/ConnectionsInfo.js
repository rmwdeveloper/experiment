...
function ConnectionsInfo() {
  return (
    <div className={cx(styles.root, 'row')}>
      ...
      <ConnectionTablet className="col-lg-3 col-md-3 col-xs-3 col-sm-3" title="Followers" amount={0} />
      <ConnectionTablet className="col-lg-3 col-md-3 col-xs-3 col-sm-3" title="Following" amount={1} />
