...
//TODO: Extremely topheavy component. Breakdown this container component into more container components. 
@connect(state => ({
  ...
  errorMessages: state.windows.errorMessages,
...
class Windows extends Component { //eslint-disable-line
  static propTypes = {
    ...
    checkAvailableSpace: PropTypes.func,
    ...
    contextMenuIndexClicked: PropTypes.string,
    ...
    showSpaceIndicator: PropTypes.bool,
